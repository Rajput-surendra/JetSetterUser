...
class OrderModel {
  ...
  factory OrderModel.fromJson(Map<String, dynamic> parsedJson) {
    ...
    String date = parsedJson[DATE_ADDED].toString();
    ...
    return OrderModel(
      id: parsedJson[ID],
      userLatitude: parsedJson['latitude'],
      userLongitude :parsedJson['longitude'],
      awbNumber: parsedJson['awb_number'],
      deliveryTip: parsedJson['delivery_tip'],
      doneted: parsedJson['donation'],
