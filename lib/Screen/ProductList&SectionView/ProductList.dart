...
class ProductList extends StatefulWidget {
   String? name, id,brandId,brandName,sellerName,sellerImage,sellerRating,sellerDic;
  ...
  final int? dis;
   ...
   ProductList(
      {Key? key, this.id, this.name, this.tag, this.fromSeller, this.dis,this.brandId,this.istrueId,this.getBrand,this.brandName,this.sellerName,this.sellerDic,this.sellerImage,this.sellerRating
      })
      : super(key: key);
...
class StateProduct extends State<ProductList> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: getAppBar(widget.name==null?'Brand Details':widget.name!, context, setStateNow,),
      key: _scaffoldKey,
      body: isNetworkAvail
          ? Stack(
              children: <Widget>[
