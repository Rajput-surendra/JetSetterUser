...
class _PassportScreenState extends State<PassportScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: getSimpleAppBar('Passport', context),
      body: Padding(
          ...
          children: [
            ...
            Expanded(
              child: SingleChildScrollView(
                child:
                    selected == 0 ? ApplyForFreshWidget() : ReIssuePassport(),
              ),
            ),
          ],
        ),
    ...
    return Form(
      ...
      child: Column(
        ...
        children: [
          ...
          ElevatedButton(
            onPressed: () async {
              if (_key.currentState!.validate() && photo != null) {
...
class ReIssuePassport extends StatefulWidget {
  @override
  State<ReIssuePassport> createState() => _ReIssueVisaState();
}

class _ReIssueVisaState extends State<ReIssuePassport> {
  InputDecoration TextFormFieldDeco = InputDecoration(
    contentPadding: EdgeInsets.all(10),
    fillColor: Colors.white,
    hintStyle: TextStyle(fontSize: 14),
