        ...
        if (CUR_USERID != null) {
          try {
            ...
            final SharedPreferences prefs = await SharedPreferences.getInstance();
              ...
              prefs.setString("sellerid",widget.model!.seller_id ?? "");
              print(widget.model!.seller_id.toString() + "SELLEEEEEEERRRRRRR");
            print('____cccccccccccccccccccc______${parameter}_________');
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    InkWell(
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            // SizedBox(width: 5,),
                                            Text(
                                              "Price: ₹ ${widget.model!.prVarientList!.first.disPrice}",style: TextStyle(
                                                fontWeight: FontWeight.bold,color: colors.primary
                                            ),
                                            ),
                                          ],
                                      ...
                                      // Text("${widget.model?.prVarientList?.first.price}"),
                                    GetTitleWidget(
