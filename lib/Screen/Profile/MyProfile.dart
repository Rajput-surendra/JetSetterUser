...
class StateProfile extends State<MyProfile> with TickerProviderStateMixin {
  ...
  _getDrawer() {
    return ListView(
      ...
      children: <Widget>[
        ...
        CUR_USERID == '' || CUR_USERID == null
            ? Container()
            : _getDrawerItem(getTranslated(context, 'My Requests')!, 'pro_wh'),
        CUR_USERID == '' || CUR_USERID == null
            ? Container()
        ...
        _getDrawerItem(getTranslated(context, 'SHIPPING_POLICY_LBL')!,
            'pro_shipping_policy'),
        _getDrawerItem(
            getTranslated(context, 'RETURN_POLICY')!, 'pro_return_policy'),
        ...
        CUR_USERID == '' || CUR_USERID == null
            ...
            CUR_USERID == '' || CUR_USERID == null
                ? Container()
                : _getDrawerItem(
                    getTranslated(context, 'LOGOUT')!, 'pro_logout'),
      ],
    );
  }
    ...
    return Card(
      ...
      child: ListTile(
        ...
        onTap: () {
          if (title == getTranslated(context, 'MY_ORDERS_LBL')) {
          ...
          } else if (title == getTranslated(context, 'My Requests')) {
            Routes.navigateToMyRequestScreen(context);
            ...
            Routes.navigateToShippingScreen(
                context: context, title: 'SHIPPING_POLICY_LBL');
          } else if (title == getTranslated(context, 'RETURN_POLICY')) {
            Routes.navigateToRefoundPolicyScreen(
                context: context, title: 'RETURN_POLICY');
          } else if (title == getTranslated(context, 'RETURN_POLICY_LBL')) {
            Routes.navigateToReFoundScreen(
  ...
  Widget getUserImage(
      String profileImage, BuildContext context, VoidCallback? onBtnSelected) {
    return Stack(
      children: <Widget>[
        GestureDetector(
          onTap: () {
