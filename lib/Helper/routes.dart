import 'package:eshop_multivendor/Screen/MyRequests/MyRequests.dart';
import 'package:eshop_multivendor/Screen/RefoundPolicy/Refound_Policy.dart';
...
import '../Screen/ReturePolicy/Return_Policy.dart';
...
import '../Screen/ShippingPolicy/Shipping_Policy.dart';
...
class Routes {
  ...
  static navigateToMyRequestScreen(BuildContext context) {
    Navigator.push(
      context,
      CupertinoPageRoute(
  ...
  static navigateToRefoundPolicyScreen(
      {required BuildContext context, required String title}) {
    Navigator.push(
      context,
      CupertinoPageRoute(
        builder: (context) => RefoundPolicy(
          title: getTranslated(context, title),
        ),
      ),
    );
  ...
  static navigateToReFoundScreen(
      {required BuildContext context, required String title}) {
    Navigator.push(
      context,
      CupertinoPageRoute(
  ...
  static navigateToShippingScreen(
      {required BuildContext context, required String title}) {
    Navigator.push(
      context,
      CupertinoPageRoute(
  ...
  static navigateToOrderSuccessScreen(BuildContext context,String orderId) {
    Navigator.pushAndRemoveUntil(
        context,
        CupertinoPageRoute(
            builder: (BuildContext context) =>  OrderSuccess(orderId: orderId,)),
