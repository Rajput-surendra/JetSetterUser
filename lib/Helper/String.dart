...
final Uri getSellerListApi = Uri.parse('${baseUrl}get_sellers');
...
final Uri getDeliveryChargeApi = Uri.parse('${baseUrl}get_delivery_charge_distacee');
...
const String deliveryTri = 'delivery_tip';
const String Donate = 'donation';
