...
class CartProvider extends ChangeNotifier {
  ...
  settotalPrice(totalPriceValue) {
    ...
    //totalPrice = totalPriceValue + dChange;
  ...
  Future <void> getDeliveryCharge() async {
    print('____Som_____getDeliveryCharge_________');
    ...
    try {
      CartRepository.fetchDeliveryCharge().then(
          ...
          if (!value['error']) {
            ...
            print('_____error______${deliveryChargeList}__________');
        ...
        if (!error) {
         ...
         // getDeliveryCharge();
          ...
          if(oriPrice < double.parse(deliveryChargeList.first.maximum ?? '0.0')){
            ...
            print('____Som______${deliveryCharge}_________');
          }
